...
/* ── NavLink ──────────────────────────────────────────── */
function NavLink({ item, expanded, locale, isActive, onClick }: {
  item: NavItem;
  expanded: boolean;
  locale: string;
  isActive: boolean;
...
/* ── UserFooter ───────────────────────────────────────── */
function UserFooter({ user, expanded, locale, onLogout }: {
  user: { email: string };
  expanded: boolean;
  locale: string;
  onLogout: () => void;
  ...
  return (
    ...
    >
      ...
      <ProfileSheet isOpen={profileOpen} onClose={() => setProfileOpen(false)} locale={locale} />
    </div>
  );
}
